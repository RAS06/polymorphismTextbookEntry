...
public class polymorphismTests {
    ...
    public static void explainPolymorphism() {
        System.out.println("Polymorphism relates to reference variables that refer to objects from different places at different points in the code." +
                "\n If an object is declared and initialized: \"Obj obj = new subObj,\" the Obj type on the left is known as the \"Declared Type,\" and" +
                ...
                "\n is overridden, the overridden method will be called instead. Casting down on objects can be performed to avoid this. Any method can be" +
                "\n overridden, including methods from the object class. These are known as polymorphic reference variables.");
    }
